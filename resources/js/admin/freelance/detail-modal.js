...
export function fetchfreelancerById(freelanceId) {
    const detailModal = document.getElementById("detailFreelancerModal");
    if (detailModal) {
        ...
        detailModal.querySelector("#freelance_phone_number").textContent = "";
        ...
        detailModal.querySelector("#freelance_education").innerHTML = "";
        detailModal.querySelector("#freelance_experience").innerHTML = "";
        detailModal.querySelector("#freelance_achievement").innerHTML = "";
        detailModal.querySelector("#freelance_skill").innerHTML = "";
    }
    axios
        ...
        .then((response) => {
            ...
            if (detailModal) {
                ...
                // Set profile picture using userPhotoProfile
                detailModal.querySelector("#profilePicture").src =
                    freelancer.data.userPhotoProfile ||
                    "/assets/img/default-avatar.jpg";

                // file CV
                const fileCV = freelancer.data.freelancer_profile.file_c_v;
                if (fileCV) {
                    const cvUrl = `/admin/freelancers/download/cv/${fileCV.file_id}`;
                    const resumeAnchor =
                        detailModal.querySelector("#freelance_resume");
                ...
                // file CV
                const fileSKKNI =
                    freelancer.data.freelancer_profile.file_s_k_k_n_i;
                if (fileSKKNI) {
                    const cvUrl = `/admin/freelancers/download/cv/${fileSKKNI.file_id}`;
                    const resumeAnchor =
                        detailModal.querySelector("#freelance_skkni");
                ...
                // file CV
                const fileSKKK =
                    freelancer.data.freelancer_profile.file_s_k_k_k;
                if (fileSKKK) {
                    const cvUrl = `/admin/freelancers/download/cv/${fileSKKK.file_id}`;
                    const resumeAnchor =
                        detailModal.querySelector("#freelance_skkk");
