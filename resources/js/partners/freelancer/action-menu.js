         ...
         <div class="relative">
            ...
            <div class="popover hidden absolute bg-white border border-gray-300 rounded shadow-lg z-50">
               <ul class="text-sm">
                  <li>
                        <button 
                            class="w-full text-left px-4 py-2 hover:bg-gray-100 detail-freelancer-btn open-detail-modal flex items-center gap-2 " data-freelancer-id="${cell}">
                    ...
                    <li>
                        <button 
                            class="w-full text-left px-4 py-2 hover:bg-gray-100 block-freelancer-btn open-block-modal flex items-center gap-2 " data-freelancer-id="${cell}">
                  ...
                  <li>
                        <button 
                            class="w-full text-left px-4 py-2 hover:bg-gray-100 unblock-freelancer-btn open-unblock-modal flex items-center gap-2" data-freelancer-id="${cell}">
                   ...
                   <li>
                        <button 
                            class="w-full text-left px-4 py-2 hover:bg-gray-100 delete-freelancer-btn open-delete-modal flex items-center gap-2" data-freelancer-id="${cell}">
