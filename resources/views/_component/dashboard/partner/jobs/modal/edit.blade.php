<div class="relative z-50 modal hidden " id="partner-jobs-edit" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                ...
                <div class="bg-white">
                    ...
                    <div class="p-5">
                        ...
                        <form class="space-y-4" action="#">
                            <input type="text" class="hidden input-id-hidden" name="id">
                            <div>
