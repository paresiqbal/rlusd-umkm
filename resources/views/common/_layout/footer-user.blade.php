    ...
    <div class="grid grid-cols-1 gap-12 lg:grid-cols-5 md:grid-cols-3 lg:gap-4">
        <div class="flex flex-col gap-4">
            ...
            <div class="flex flex-col gap-3">
                <div class="flex items-center gap-2"><i class="text-gray-500 ti ti-map-pin"></i>Rejang Lebong</div>
                <div class="flex items-center gap-2"><i class="text-gray-500 ti ti-brand-whatsapp"></i>+62 821 82727436
                </div>
                <div class="flex items-center gap-2"><i class="text-gray-500 ti ti-at"></i>sekretariat@rlusd.id</div>
            </div>
        </div>
        ...
        <div class="flex flex-col gap-4 text-16">
            ...
            <div class="flex items-center gap-3">
                ...
                <a class="font-bold text-gray-500 cursor-pointer w-fit hover:text-primary-500" href="#"><svg
                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        fill="currentColor">
