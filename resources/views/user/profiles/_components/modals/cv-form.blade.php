<div class="relative z-50 modal hidden" x-data="cvUploadHandler" id="user-profile-cv-form" aria-labelledby="modal-title"
        ...
        <div class="p-4 mx-auto animate-translate sm:max-w-lg">
            <div class="relative overflow-hidden text-left transition-all transform bg-white rounded-lg shadow-xl">
                <div class="bg-white">
                    ...
                    <div class="p-5">
                        <h3 class="mb-4 text-xl font-medium text-gray-700">Upload CV Anda</h3>
                        <form enctype="multipart/form-data" class="space-y-4"
                            action="{{ route('users.profiles.cv.update') }}" method="POST"
                            @submit.prevent="submitForm">
                            @csrf
                            <div class="flex items-center justify-center w-full">
                                <label for="input-cv" x-ref="dropzone"
                                    ...
                                    <input type="file" name="cv_file" @change="handleFileUpload($event)"
                                        accept="application/pdf" id="input-cv"
