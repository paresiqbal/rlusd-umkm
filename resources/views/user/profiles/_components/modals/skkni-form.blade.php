<div class="relative z-50 modal hidden" x-data="skkniUploadHandler" id="user-profile-skkni-form" aria-labelledby="modal-title"
        ...
        <div class="p-4 mx-auto animate-translate sm:max-w-lg">
            <div class="relative overflow-hidden text-left transition-all transform bg-white rounded-lg shadow-xl">
                <div class="bg-white">
                    ...
                    <div class="p-5">
                        <h3 class="mb-4 text-xl font-medium text-gray-700">Upload SKKNI Anda</h3>
                        <form enctype="multipart/form-data" class="space-y-4"
                            action="{{ route('users.profiles.skkni.update') }}" method="POST"
                            @submit.prevent="submitForm">
                            @csrf
                            <div class="flex items-center justify-center w-full">
                                <label for="input-skkni" x-ref="dropzone"
                                    ...
                                    <input type="file" name="skkni_file" @change="handleFileUpload($event)"
                                        accept="application/pdf" id="input-skkni"
...
@push('scripts')
    <script>
        document.addEventListener('alpine:init', () => {
            console.log('skkniUploadHandler');
            Alpine.data('skkniUploadHandler', () => ({
                fileSelected: false,
                selectedFileName: '',
                errorMessage: '',
