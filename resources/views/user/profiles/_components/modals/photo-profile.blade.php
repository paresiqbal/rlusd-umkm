<div class="relative z-50 modal hidden" id="{{ $modalId ?? 'user-profile-picture-modal' }}" aria-labelledby="modal-title"
            ...
            <div class="relative overflow-hidden text-left transition-all transform bg-white rounded-lg shadow-xl">
                <div class="bg-white">
                    ...
                    <div class="p-5">
                        ...
                        <form id="profile-picture-form" action="{{ route('users.profiles.update-photo') }}"
